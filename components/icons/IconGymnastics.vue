<template>
  <svg
    ...
    style="enable-background:new 0 0 61.858 61.858;"
    xml:space="preserve"
  >
    <g>
      <g>
        <path
          style="fill:#010002;"
          d="M50.097,0.014c-9.917,0.874-17.235,5.824-21.501,12.98c-2.859,3.584-8.57,14.526-10.647,20.254
        ...
        ></path>
        <circle style="fill:#010002;" cx="43.653" cy="15.635" r="5.275"></circle>
      </g>
    </g>
    <g></g>
    <g></g>
