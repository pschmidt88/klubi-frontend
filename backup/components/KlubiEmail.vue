...
<template>
  <div class="flex flex-col">
    <label :class="[errorClassForLabel]" class="pb-2 text-sm font-bold text-gray-800">
      <slot name="label">
        {{ label }}
      </slot>
    </label>
    ...
    <div class="relative">
      ...
      <input v-model="value" type="email" @blur="$emit('blur', $event.target)" :placeholder="placeholder"
