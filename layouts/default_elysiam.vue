          ...
          <div class="off-sidebar-container">
            <header class="off-sidebar-header">
              ...
              >
                ...
                <li>
                  <a id="today-tab" data-toggle="tab" href="#today" role="tab"
                    >Today</a
                  >
                </li>
              </ul>
              <a href="#off-canvas" class="off-sidebar-close" />
            </header>
                ...
                >
                  ...
                  <div class="messenger-message messenger-message-sender">
                    ...
                    <div class="messenger-message-wrapper">
                      ...
                      <div class="messenger-details">
                        <span
                          class="messenger-message-localization font-size-small"
                          >2 minutes ago</span
                        >
                      </div>
                    </div>
                  ...
                  <div class="messenger-message messenger-message-recipient">
                    <div class="messenger-message-wrapper">
                      ...
                      <div class="messenger-details">
                        <span
                          class="messenger-message-localisation font-size-small"
                          >3 minutes ago</span
                        >
                      </div>
                    </div>
