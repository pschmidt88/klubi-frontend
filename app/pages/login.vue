...
definePageMeta({
  layout: "two-column-cover-image",
});
</script>

<template>
  <div :class="cn('flex flex-col gap-6')">
    <form :class="cn('grid gap-6')">
    ...
    <div class="grid gap-6">
      <div
        class="gap-2 relative text-center text-sm after:absolute after:inset-0 after:top-1/2 after:z-0 after:flex after:items-center after:border-t after:border-border">
